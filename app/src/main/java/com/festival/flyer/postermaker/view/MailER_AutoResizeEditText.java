...
public class MailER_AutoResizeEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public MailER_AutoResizeEditText(final Context context) {
        this(context, null, 0);
    }

    public MailER_AutoResizeEditText(final Context context, final AttributeSet attrs) {
