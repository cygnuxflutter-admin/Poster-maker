...
public class MailER_MainSecurity {
     ...
     */
    private MailER_MainSecurity(@Nullable String initVector, @Nullable String data, @Nullable String errorMessage) {
        super();
     ...
     */
    public static MailER_MainSecurity encrypt(String secretKey, String plainText) {
        ...
        try {
            ...
            return new MailER_MainSecurity(initVector, result, null);
        } catch (Throwable t) {
            t.printStackTrace();
            // Operation failed
            return new MailER_MainSecurity(initVector, null, t.getMessage());
        }
    }
     ...
     */
    public static MailER_MainSecurity decrypt(String secretKey, String cipherText) {
        try {
            // Check secret length
            if (!isKeyLengthValid(secretKey)) {
                throw new Exception("Secret key's length must be 128, 192 or 256 bits");
            ...
            return new MailER_MainSecurity(bytesToHex(ivParameterSpec.getIV()), result, null);
        } catch (Throwable t) {
            t.printStackTrace();
            // Operation failed
            return new MailER_MainSecurity(null, null, t.getMessage());
        }
    }
