 ...
 */
public class MailER_GDPRChecker {
    private static final String TAG = "GDPRChecker";
    private ConsentInformation consentInformation;
    private Activity context;
    private String privacyUrl;
    private String[] publisherIds;
    private static MailER_GDPRChecker instance;
    private ConsentForm consentForm;
    private static int status = ConsentInformation.ConsentStatus.REQUIRED;
    private boolean withAdFreeOption = false;

    protected MailER_GDPRChecker(Activity context) {
        this.context = context;
        this.consentInformation = UserMessagingPlatform.getConsentInformation(context);
    }

    public MailER_GDPRChecker() {
    }

    public MailER_GDPRChecker withContext(Activity context) {
        instance = new MailER_GDPRChecker(context);
        return instance;
    }

    public MailER_GDPRChecker withPrivacyUrl(String privacyUrl) {
    ...
    public MailER_GDPRChecker withPublisherIds(String... publisherIds) {
