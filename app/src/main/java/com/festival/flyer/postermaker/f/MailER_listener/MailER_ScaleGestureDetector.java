...
public class MailER_ScaleGestureDetector {
    ...
    private MailER_Vector2D mCurrSpanVector = new MailER_Vector2D();
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, MailER_ScaleGestureDetector scaleGestureDetector);

        boolean onScaleBegin(View view, MailER_ScaleGestureDetector scaleGestureDetector);

        void onScaleEnd(View view, MailER_ScaleGestureDetector scaleGestureDetector);
    }
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, MailER_ScaleGestureDetector detector) {
        }
    }

    public MailER_ScaleGestureDetector(OnScaleGestureListener listener) {
    ...
    public MailER_Vector2D getCurrentSpanVector() {
