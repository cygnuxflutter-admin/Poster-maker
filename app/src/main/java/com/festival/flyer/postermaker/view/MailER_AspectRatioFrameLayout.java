 ...
 */
public final class MailER_AspectRatioFrameLayout extends FrameLayout {

    /**
     * Resize modes for {@link MailER_AspectRatioFrameLayout}.
     */
    ...
    public MailER_AspectRatioFrameLayout(Context context) {
        this(context, null);
    }

    public MailER_AspectRatioFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
