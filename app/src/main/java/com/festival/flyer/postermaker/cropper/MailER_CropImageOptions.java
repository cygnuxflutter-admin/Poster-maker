 ...
 */
public class MailER_CropImageOptions implements Parcelable {

  public static final Creator<MailER_CropImageOptions> CREATOR =
      new Creator<MailER_CropImageOptions>() {
        @Override
        public MailER_CropImageOptions createFromParcel(Parcel in) {
          return new MailER_CropImageOptions(in);
        }

        @Override
        public MailER_CropImageOptions[] newArray(int size) {
          return new MailER_CropImageOptions[size];
        }
      };

  /** The shape of the cropping window. */
  public MailER_CropImageView.CropShape cropShape;
  ...
  public MailER_CropImageView.Guidelines guidelines;

  /** The initial scale type of the image in the crop image view */
  public MailER_CropImageView.ScaleType scaleType;
  ...
  public MailER_CropImageView.RequestSizeOptions outputRequestSizeOptions;
  ...
  public MailER_CropImageOptions() {

    DisplayMetrics dm = Resources.getSystem().getDisplayMetrics();

    cropShape = MailER_CropImageView.CropShape.RECTANGLE;
    ...
    guidelines = MailER_CropImageView.Guidelines.ON_TOUCH;
    scaleType = MailER_CropImageView.ScaleType.FIT_CENTER;
    ...
    outputRequestSizeOptions = MailER_CropImageView.RequestSizeOptions.NONE;
    noOutputImage = false;
  ...
  protected MailER_CropImageOptions(Parcel in) {
    cropShape = MailER_CropImageView.CropShape.values()[in.readInt()];
    snapRadius = in.readFloat();
    touchRadius = in.readFloat();
    guidelines = MailER_CropImageView.Guidelines.values()[in.readInt()];
    scaleType = MailER_CropImageView.ScaleType.values()[in.readInt()];
    ...
    outputRequestSizeOptions = MailER_CropImageView.RequestSizeOptions.values()[in.readInt()];
