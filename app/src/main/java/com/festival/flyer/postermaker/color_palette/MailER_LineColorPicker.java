package com.festival.flyer.postermaker.color_palette;
...
public class MailER_LineColorPicker extends View {
	...
	private MailER_OnColorChangedListener onColorChanged;

	private int cellSize;

	private int mOrientation = HORIZONTAL;

	public MailER_LineColorPicker(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param l
	 */
	public void setOnColorChangedListener(MailER_OnColorChangedListener l) {
