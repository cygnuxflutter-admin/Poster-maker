...
final class MailER_CropImageAnimation extends Animation implements Animation.AnimationListener {
  ...
  public MailER_CropImageAnimation(ImageView cropImageView, MailER_CropOverlayView cropOverlayView) {
