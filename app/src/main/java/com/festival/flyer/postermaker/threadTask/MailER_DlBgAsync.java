...
public class MailER_DlBgAsync extends AsyncTask<String, String, String> {
    ...
    public MailER_DlBgAsync(Activity activity, ArrayList<String> stringArrayList, OnDownloadTemplateListener onDownloadTemplateListener) {
