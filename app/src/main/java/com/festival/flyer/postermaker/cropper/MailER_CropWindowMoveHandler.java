 ...
 * <br>
 */
final class MailER_CropWindowMoveHandler {
   ...
   */
  public MailER_CropWindowMoveHandler(
          Type type, MailER_CropWindowHandler cropWindowHandler, float touchX, float touchY) {
    mType = type;
